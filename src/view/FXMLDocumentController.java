...
public class FXMLDocumentController implements Initializable {
	...
	private void checkElementsForm(boolean condition, String header, String contentText) {
		if (condition) {
    		...
    		new AlertAbstractFactory().createErrorAllert("Uno o pi� Campi sono Errati!").showAndWait();
    	}
	}
    ...
    private void showPuntataConduttore() throws SQLException {
    	...
    	if(Parse.validationTextPuntataConduttore(value, vingola)) {
    		...
    		new AlertAbstractFactory().createErrorAllert("ERRORE: Il valore inserito non � conforme al formato richiesto!").showAndWait();
    	}
    }
